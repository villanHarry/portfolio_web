...
List<Project> projectList = [
  Project(
    ...
    'https://github.com/villanharry/Coffe-Shop-Beautifull-UI',
  ),
  Project(
    ...
    'https://github.com/villanharry/Car-Controller-Getx-Flutter',
  ),
  Project(
      'Neumorphic Clockify',
  ...
  Project(
      ...
      'https://github.com/villanharry/Food-Recipe-App-Flutter'),
  Project(
      'Task Sync Pro',
  ...
  Project(
      ...
      'https://github.com/villanharry/Messenger-App-Backend-Firebase'),
  Project(
